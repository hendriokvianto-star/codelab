...
export default function HomeScreen() {
  ...
  const COURSES = [
    ...
    { id: 'ai', icon: '🤖', title: 'AI & Prompt Eng.', desc: language === 'id' ? 'Kuasai LLM dan integrasi AI' : 'Master LLMs and AI integration', category: 'Fundamental', color: '#8A2BE2', modules: 1, lessons: 3 },
