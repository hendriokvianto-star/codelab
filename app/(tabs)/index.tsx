...
export default function HomeScreen() {
  ...
  const COURSES = [
    ...
    { id: 'security', icon: '🛡️', title: 'Web Security', desc: language === 'id' ? 'Pelajari cara melindungi aplikasi web dari kerentanan' : 'Learn to defend web apps against vulnerabilities', category: 'Fundamental', color: '#E3242B', modules: 1, lessons: 3 },
