...
export const BADGES = {
  ...
  SECURITY_SCOUT: {
    id: 'security_scout',
    name: 'Security Scout',
    nameId: 'Pramuka Keamanan',
    description: 'Complete Security Module 1',
    descriptionId: 'Selesaikan Module 1 Security',
    emoji: '🛡️',
  },
  AUTH_DEFENDER: {
    id: 'auth_defender',
    name: 'Auth Defender',
    nameId: 'Pembela Autentikasi',
    description: 'Complete Security Module 2',
    descriptionId: 'Selesaikan Module 2 Security',
    emoji: '🔐',
  },
  CYBER_NINJA: {
    id: 'cyber_ninja',
    ...
    descriptionId: 'Selesaikan semua module Security',
    emoji: '🥷',
  },
  GOPHER_NOVICE: {
    id: 'gopher_novice',
    name: 'Gopher Novice',
    nameId: 'Gopher Pemula',
    description: 'Complete Golang Module 1',
    descriptionId: 'Selesaikan Module 1 Golang',
    emoji: '🐹',
  },
  API_BUILDER: {
    id: 'api_builder',
    name: 'API Builder',
    nameId: 'Pembangun API',
    description: 'Complete Golang Module 2',
    descriptionId: 'Selesaikan Module 2 Golang',
    emoji: '🔌',
  },
  MICROSERVICE_EXPERT: {
    id: 'microservice_expert',
    name: 'Microservice Expert',
    nameId: 'Pakar Microservice',
    description: 'Complete all Golang modules',
    descriptionId: 'Selesaikan semua module Golang',
    emoji: '🧩',
  },
  AI_APPRENTICE: {
    id: 'ai_apprentice',
    name: 'AI Apprentice',
    nameId: 'Pemula AI',
    description: 'Complete AI Module 1',
    descriptionId: 'Selesaikan Module 1 AI',
    emoji: '🤖',
  },
  PROMPT_ENGINEER: {
    id: 'prompt_engineer',
    name: 'Prompt Engineer',
    nameId: 'Insinyur Prompt',
    description: 'Complete AI Module 2',
    descriptionId: 'Selesaikan Module 2 AI',
    emoji: '🧠',
  },
  AI_ARCHITECT: {
    id: 'ai_architect',
    ...
    descriptionId: 'Selesaikan semua module AI',
    emoji: '⚙️',
  },
  WIDGET_BUILDER: {
    id: 'widget_builder',
    name: 'Widget Builder',
    nameId: 'Pembangun Widget',
    description: 'Complete Flutter Module 1',
    descriptionId: 'Selesaikan Module 1 Flutter',
    emoji: '🧱',
  },
  STATE_MASTER: {
    id: 'state_master',
    name: 'State Master',
    nameId: 'Master State',
    description: 'Complete Flutter Module 2',
    descriptionId: 'Selesaikan Module 2 Flutter',
    emoji: '🔄',
  },
  FLUTTER_DEVELOPER: {
    id: 'flutter_developer',
    name: 'Flutter Developer',
    nameId: 'Developer Flutter',
    description: 'Complete all Flutter modules',
    descriptionId: 'Selesaikan semua module Flutter',
    emoji: '📱',
  },
  PERFECT_SCORE: {
    id: 'perfect_score',
